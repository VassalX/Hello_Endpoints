...
function greetByGender(){
	var name = document.getElementById("name_field").value;
	var period = document.getElementById("period_field").value;
	var form = document.getElementById("gender_field");
	var gender = form.elements["gender_field"].value;
	var request = gapi.client.helloworldendpoints.greetByGender({'name': name,'period' : period,'gender' : gender});
	request.execute(sayHelloCallback);
}
